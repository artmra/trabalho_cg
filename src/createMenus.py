...
class CreatePointMenu(CreateMenu):
    def __init__(self, viewport: Viewport, objListView: QComboBox):
        ...
        layout.addWidget(QLabel('Valores RGB'), 3, 0, 1, 2)
        layout.addWidget(QLabel('R:'), 4, 0)
        layout.addWidget(self.R, 4, 1)
        layout.addWidget(QLabel('G:'), 5, 0)
        layout.addWidget(self.G, 5, 1)
        layout.addWidget(QLabel('B:'), 6, 0)
        layout.addWidget(self.B, 6, 1)
        layout.addWidget(self.createButton, 7, 0)
...
class CreateLineMenu(CreateMenu):
    def __init__(self, viewport: Viewport, objListView: QComboBox):
        ...
        layout.addWidget(QLabel('B:'), 6, 0)
        layout.addWidget(self.B, 6, 1)
        layout.addWidget(self.createButton, 7, 0, 1, 2)
        layout.addWidget(self.cancelButton, 7, 3, 1, 2)
        self.setLayout(layout)
